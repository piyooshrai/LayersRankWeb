...
const footerColumns = [
  {
    ...
    links: [
      ...
      { label: 'Adaptive Follow-Up', href: '/product#adaptive-followup' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Technical Hiring', href: '/solutions/gcc' },
      { label: 'Campus Hiring', href: '/solutions/startups' },
      { label: 'Leadership Hiring', href: '/solutions/gcc' },
    ],
  },
  {
    title: 'Compare',
    links: [
      ...
      { label: 'vs HackerRank', href: '/compare/hirevue' },
      { label: 'vs Codility', href: '/compare/hirevue' },
      { label: 'vs Phone Screens', href: '/compare/hirevue' },
    ],
  },
  {
    title: 'Resources',
    links: [
      ...
      { label: 'Sample Report', href: '/resources' },
